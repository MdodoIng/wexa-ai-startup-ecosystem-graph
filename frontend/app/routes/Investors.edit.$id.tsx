...
export default function InvestorEdit() {
  ...
  return (
    <div className="page form-page">
      <Link to={`/investors/${id}`} className="back-link"><ArrowLeft size={18} /> Back</Link>
      <h1>Edit Investor</h1>
      <form onSubmit={handleSubmit} className="form">
        ...
        <label>Logo<input required maxLength={4} value={form.logo} onChange={e => setForm({...form, logo: e.target.value.toUpperCase()})} /></label>
